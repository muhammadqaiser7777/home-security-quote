...
export class Faq {
  faqs: FaqItem[] = [
    {
      question: 'How does the home security quote process work?',
      answer: 'Fill out our detailed form with your home security project information. We securely process your data and connect you with trusted contractors in your area who will provide personalized quotes.',
      isOpen: false
    },
    {
    ...
    },
    {
      ...
      answer: 'We partner only with experienced, trusted home security professionals who have proven track records, positive customer reviews, and meet our quality standards. All contractors undergo background checks.',
      isOpen: false
    },
    {
    ...
    {
      question: 'What types of home security services do you cover?',
      answer: 'We cover all major home security services including installation, repair, replacement & maintenance.',
      isOpen: false
    },
    ...
    },
    {
      ...
      answer: 'Basic project details including home security type, property type, project nature (install/repair/replace), timeline, and contact information. More details help contractors provide accurate quotes.',
      isOpen: false
    }
  ];
